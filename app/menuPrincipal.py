...
def menuPrincipal():
    ...
    while True:
        ...
        print('7 - Qual o percentual de pessoas acima de 60 anos que foram levadas a óbito pelo Covid-19 no Maranhão em relação à não idosas no mês onde foi registrado a maior quantidade de casos?')
